...
for ($i = 0; $i < $countOnPage; $i++) {
    ...
    echo "\"content\":\"" . $desc . "\"" . PHP_EOL;
    $desc = "http://www.techlab.nl/backbone/wordpress/wp-content/uploads/2015/08/Screen-Shot-2015-09-07-at-11.45.33.png";
    echo "\"thumbnail\":\"" . $desc . "\"" . PHP_EOL;
	$desc = "http://www.techlab.nl/backbone/wordpress/octpopus/"; 
    echo "\"href\":\"" . $desc . "\"" . PHP_EOL;    
    echo "}";
